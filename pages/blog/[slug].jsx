              ...
              {myData.comments.length > 0 && (
                <div className="grid lg:grid-cols-3">
                  <div className="lg:col-span-2">
                    ...
                    {myData.comments.map((item) => (
                      <div
                        className="mt-[16px] bg-white border-[1.5px] border-[#3B444F]/10 pt-[32px] pl-[24px] pr-[28px] pb-[31px]"
                        key={item.id}
                      >
                        <div className="flex items-center gap-[12px]">
                          ...
                          />
                          <div>
                            <h4 className="font-[700] text-[20px] text-[#262323]">
                              {item.fullName}
                            </h4>
                            <p className="mt-[8px] text-[16px] font-[400] text-[#6F6767]">
                              wrote a comment on{" "}
                              {format(item.created_at, "dd MMMM yyyy")}.
                            </p>
                          </div>
                        </div>
                        <div className="mt-[20px] text-[16px] font-[500] text-[#6F6767]">
                          {item.comment}
                        </div>
                      </div>
                    ))}
